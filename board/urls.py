...
urlpatterns = [
    ...
    path('comment/modify/<int:post_id>/<int:comment_id>/', views.comment_modify, name='comment_modify'),
    path('comment/delete/<int:post_id>/<int:comment_id>/', views.comment_delete, name='comment_delete'),
]